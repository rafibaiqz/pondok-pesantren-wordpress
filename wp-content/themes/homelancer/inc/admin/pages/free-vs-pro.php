<?php
$homelancer_features = array(
	array(
		'label' => 'Pre-built Starter sites',
		'free'  => '1',
		'pro'   => '2 (Including free demos)',
	),
	array(
		'label' => 'Pre-built Sections',
		'free'  => '30+',
		'pro'   => '60+ (Including free)',
	),
	array(
		'label' => 'Global Styles',
		'free'  => true,
 ...
 *
 * @example
 * homelancer_get_feature_status_icon( true );  // Outputs a check mark icon.
 * homelancer_get_feature_status_icon( false ); // Outputs a cross icon.
 * homelancer_get_feature_status_icon( 'Coming Soon' ); // Outputs "Coming Soon" as a text status.
 */
function homelancer_get_feature_status_icon($status)
{
	$allowed_tags = array(
		'div'  => array(
			'class' => true,
...
<div class="homelancer-page__free-pro">
	<h3><?php esc_html_e('HomeLancer Free vs. Pro', 'homelancer'); ?></h3>

	<div class="checkout-button-container top">
		<a href="<?php echo esc_url('https://cozythemes.com/pricing-and-plans/'); ?>" class="checkout-button"><?php esc_html_e('Already enjoying our product?', 'homelancer'); ?></a>
	</div>

	<table>
		<tr>
			<th><?php esc_html_e('Feature', 'homelancer'); ?></th>
			<th><?php esc_html_e('Free', 'homelancer'); ?></th>
			<th><?php esc_html_e('Pro', 'homelancer'); ?></th>
		</tr>

		<?php
		if (isset($homelancer_features) && ! empty($homelancer_features)) :
			foreach ($homelancer_features as $feature) {
		?>
				<tr>
					<td>
						<?php
					...
					<td>
						<?php homelancer_get_feature_status_icon($feature['free']); ?>
					</td>

					<td>
						<?php homelancer_get_feature_status_icon($feature['pro']); ?>
					</td>
				</tr>
		<?php
			}
	...
	<br />
	<p><?php esc_html_e('Explore More features and details comparison on ', 'homelancer'); ?>
		<a href="<?php echo esc_url('https://cozythemes.com/homelancer/'); ?>" target="_blank"><?php esc_html_e('Here', 'homelancer'); ?></a>
	</p>
	...
	<div class="refund-policy">
		...
		<div class="policy">
			<h3><?php esc_html_e('No Risk, 100% Money Back Guarantee!', 'homelancer'); ?></h3>
			<p><?php esc_html_e('Our Refund Policy secures customer satisfaction and protection. If you find our purchased products unusable, despite our team’s support, you can claim a full refund within 30 days.', 'homelancer'); ?></p>
		</div>
	</div>

	<!-- Checkout Button Section -->
	<div class="checkout-button-container bottom">
		<?php esc_html_e('Ready to take the next step? Let’s get you to', 'homelancer'); ?> <a href="<?php echo esc_url('https://cozythemes.com/pricing-and-plans/'); ?>" class="checkout-button"><?php esc_html_e('Checkout!', 'homelancer'); ?></a> <?php esc_html_e('🚀', 'homelancer'); ?>
	</div>
</div>
<?php
