...
<h1 class="wp-block-heading has-text-align-center" style="font-size:32px;font-style:normal;font-weight:700"><?php echo esc_html__( 'Blog Right Sidebar', 'venture-grove' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
...
<p class="has-text-align-center"><?php echo esc_html__( 'No posts found', 'venture-grove' ); ?></p>
<!-- /wp:paragraph -->
