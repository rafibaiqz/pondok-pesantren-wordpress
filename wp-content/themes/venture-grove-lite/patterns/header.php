...
/**
 * Title: Header
 * Slug: venture-grove-lite/header
...
<div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-background wp-element-button" style="padding-top:12px;padding-right:30px;padding-bottom:12px;padding-left:30px"> <?php echo esc_html__( 'Suscribe', 'venture-grove-lite' ); ?> </a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->