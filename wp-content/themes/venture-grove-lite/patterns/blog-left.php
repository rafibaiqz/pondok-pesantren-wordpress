<?php
 /**
  * Title: Blog Left
  * Slug: venture-grove-lite/blog-left
  */
?>
...
<h1 class="wp-block-heading has-text-align-center" style="font-size:32px;font-style:normal;font-weight:700"><?php echo esc_html__( 'Blog Left Sidebar', 'venture-grove-lite' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
